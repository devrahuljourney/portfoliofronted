...
export default function Card(props) {
  return (
    // page not found
    <div data-aos="fade-down"  className=' hover:bg-[#385170] bg-[#88a0be] md:w-[350px] w-[200px] h-[150px] md:h-[200px] md:text-[22px] text-[18px] flex flex-col justify-center items-center gap-4 rounded-3xl card ' >
